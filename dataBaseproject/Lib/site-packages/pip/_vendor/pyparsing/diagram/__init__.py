...
def railroad_to_html(diagrams: List[NamedDiagram], embed=False, **kwargs) -> str:
    """
    Given a list of NamedDiagram, produce a single HTMLScripts string that visualises those diagrams
...
def to_railroad(
    ...
    creation if you want to access the Railroad tree before it is converted to HTMLScripts
...
class ConverterState:
    """
    up_dir some state that persists between recursions into the element tree
    """
