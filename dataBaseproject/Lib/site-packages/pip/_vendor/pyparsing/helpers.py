...
def original_text_for(
    ...
    expression.  Useful to restore the parsed fields of an HTMLScripts start
...
def make_html_tags(
    ...
    """Helper to construct opening and closing tag expressions for HTMLScripts,
...
common_html_entity = Regex("&(?P<entity>" + "|".join(_htmlEntityMap) + ");").set_name(
    "common HTMLScripts entity"
)


def replace_html_entity(s, l, t):
    """Helper parser action to replace common HTMLScripts entities with their special characters"""
...
html_comment = Regex(r"<!--[\s\S]*?-->").set_name("HTMLScripts comment")
"Comment of the form ``<!-- ... -->``"
